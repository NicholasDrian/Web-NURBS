...
Web NURBS is 3D modeling software designed to run in your browser. It uses WebGPU (the successor to WebGL) for performant GPU computation. The program is written in about 12k lines of TypeScript and WGSL. 
